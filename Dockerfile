...
# Update the CMD line at the end of your Dockerfile
CMD gunicorn --log-level debug --workers 1 --threads 4 --timeout 120 --capture-output --enable-stdio-inheritance --access-logfile - --error-logfile - --bind 0.0.0.0:8080 wsgi:application
